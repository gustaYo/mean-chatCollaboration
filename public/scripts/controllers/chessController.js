...
angular.module(AppName).controller('chessController', chessController);
function chessController($scope, $location, Socket, $log, Authentication) {
    var socket = Socket.socket;
    socket.emit('nickname', Authentication.getUser(), function(nick) {
        console.log(nick)
    });
    var vm = this;
    $scope.users = [];
